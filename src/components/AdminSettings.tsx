  ...
  return (
    <div className="flex-1 overflow-y-auto bg-background-light p-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              ...
              <div className="flex gap-4">
                <div>
                  ...
                  <select className="bg-gray-100 border-none rounded-lg py-2 px-4 text-sm font-medium text-secondary outline-none focus:ring-2 focus:ring-primary">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              ...
              <div>
                ...
                <select className="bg-gray-100 border-none rounded-lg py-2 px-4 text-sm font-medium text-secondary outline-none focus:ring-2 focus:ring-primary w-48">
                  <option>7 Days Since Last Visit</option>
                  <option>14 Days Since Last Visit</option>
                </select>
              </div>
            </div>
          </div>
      ...
      <div className="mt-8 flex justify-end gap-4">
        ...
        <button className="px-6 py-3 bg-primary text-secondary font-bold rounded-xl shadow-sm hover:bg-primary/90 transition-colors flex items-center gap-2">
          <Check size={20} />
          Save Changes
        </button>
      </div>
