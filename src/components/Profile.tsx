      ...
      <div className="bg-white rounded-2xl p-8 shadow-sm w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          <div className="w-32 h-32 rounded-full border-4 border-primary p-1 mb-4 relative">
            <img 
              src="https://api.dicebear.com/7.x/avataaars/svg?seed=Arif&backgroundColor=ffdfbf" 
              alt="Profile" 
        ...
        <form className="space-y-5">
          <div className="relative">
            <label className="absolute -top-2.5 left-3 bg-white px-1 text-xs font-medium text-accent">First Name</label>
            <input 
              type="text" 
              defaultValue="Arif"
          ...
          <div className="relative">
            <label className="absolute -top-2.5 left-3 bg-white px-1 text-xs font-medium text-accent">Last Name</label>
            <input 
              type="text" 
          ...
          <div className="relative">
            ...
            <input 
              type="email" 
              defaultValue="arif.h@example.com"
              className="w-full border-2 border-accent/40 rounded-lg px-4 py-3 text-secondary font-medium focus:border-secondary focus:ring-0 outline-none"
            />
          </div>
